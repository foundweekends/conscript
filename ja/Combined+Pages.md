...
多分思ったより少ないことしか行わない。なぜなら sbt ランチャーが思ったより多くのことをこなすからだ。それに関してはまた後で。
  ...
  [runnable]: https://repo1.maven.org/maven2/org/foundweekends/conscript/conscript_2.11/0.5.9/conscript_2.11-0.5.9-proguard.jar
...
```
$ java -jar conscript_2.11-0.5.9-proguard.jar
```
